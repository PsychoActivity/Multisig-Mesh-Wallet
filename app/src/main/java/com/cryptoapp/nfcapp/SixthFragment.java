...
public class SixthFragment extends Fragment {
    ...
    private static final String ARG_MS_ADDR = "multiSigAddress";

    // TODO: Rename and change types of parameters
    private String mParam1;
    private String mParam2;
    private String addr;
    private TextView multiSigPubAddr;
    ...
    public static SixthFragment newInstance(int layoutResId, String address) {
        SixthFragment SixthFragment = new SixthFragment();

        Bundle args = new Bundle();
        args.putInt(ARG_LAYOUT_RES_ID, layoutResId);
        args.putString(ARG_MS_ADDR, address);
        SixthFragment.setArguments(args);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            addr = getArguments().getString(ARG_MS_ADDR);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        multiSigPubAddr = v.findViewById(R.id.multisig_pub_address);
        multiSigPubAddr.setText(addr);
        return v;
    }
